...
public final class UwBean {
	...
	/**
	 * Find all subclass types of the specified service provider interface class or return a default value.
	 *
	 * @param clazz			service provider interface class
	 * @param classLoader	class loader to load classes by their names
	 * @param defaultValue	default value to return on failure
	 * @param <T>			interface type
	 * @return				list of subclass types or the default value
	 */
	...
	/**
	 * Find all subclass types of the specified service provider interface class or return {@code null}.
	 *
	 ...
	 * @param classLoader	class loader to load classes by their names
	 * @param <T>			interface type
	 * @return				list of subclass types or {@code null}
	 */
